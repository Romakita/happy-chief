...
/**
 * Created by romak_000 on 11/11/2014.
 */
module.exports = {
    /**
     * Gère les routes
    ...
    initialize: function(app){
        ...
        app
            ...
            .get('/users/:user/recipes', function(request, response) {//Enregistrement du formulaire candidate

                self.listRecipes({user:request.params.user})
                    .then(function(o){
                        response.setHeader('Content-Type', 'text/json');
                        response.json(200, o);
