...
Recipe.initialize = function(app){
    ...
    app.get('/recettes/get/:id', function(request, response) {//Enregistrement du formulaire candidate
    ...
    app.post('/recettes/save', function(request, response) {//Enregistrement du formulaire candidate
    ...
    app.get('/recettes/list', function(request, response) {//Enregistrement du formulaire candidate

        Recipe.getList(request.body, function(array){
    ...
    /*app.delete('/recettes/remove/:id', function(request, response) {//Enregistrement du formulaire candidate
