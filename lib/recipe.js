...
Recipe.commit = function(o){
    ...
    if(typeof o._id == 'undefined'){//save
        ...
        return new Promise(function(resolve, reject){
            ...
            new Recipe(o).save(function(err, o){
        ...
        return new Promise(function (resolve, reject) {
            ...
            Recipe.update({_id: id}, data, {upsert: true}, function (err) {
                if(err){
                    reject(err);
                }else{
                    o._id = id;
...
Recipe.initialize = function(app){
    ...
    app
        ...
        .get('/recipes/random/:nb?', function(request, response) {//Enregistrement du formulaire candidate
            ...
            Recipe.randomList(request.params.nb).then(function(array){
...
Recipe.randomList = function(size){
